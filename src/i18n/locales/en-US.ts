export default {
  common: {
    ...
    downloadRetry: 'Download failed, please try again',
    ...
    pleaseUploadFile: 'Please upload patent file first',
    pleaseCompleteInfo: 'Please complete all information',
    analysisSubmitted: 'Analysis task submitted, please check results in history',
    analysisFailed: 'Analysis failed',
    fileFormatError: 'Only PDF, DOC, DOCX formats are supported!',
    fileSizeError: 'File size cannot exceed 10MB!',
    uploading: 'Uploading file...',
    uploadSuccess: 'File uploaded successfully',
    uploadFailed: 'File upload failed',
    notLoggedIn: 'Not logged in, please login first',
    reportGenerateSuccess: 'Operation successful',
    reportGenerateFailed: 'Report generation failed',
    pleaseEnterTechField: 'Please enter technical field description',
    draftSaveSuccess: 'Draft saved successfully',
    draftSaveFailed: 'Draft save failed',
    reportDownloading: 'Downloading report...',
    pleaseEnterAllRequired: 'Please fill in all required fields correctly',
    generatingDraft: 'System is analyzing your technical solution and generating patent draft...',
  ...
  menu: {
    ...
    defenseAnnotation: 'Annotation Reply',
    ...
    subtitle: 'Upload patent documents to generate annotation reply opinions',
    uploadTitle: 'Patent Document Upload',
    uploadText: 'Drag patent application documents here,',
    clickUpload: 'click to upload',
    fileFormatTip: 'Supports PDF, DOC, DOCX formats, file size not exceeding 10MB',
    generateAnnotationReply: 'Generate Annotation Reply',
    taskRecords: 'Task Records',
    statusFilter: 'Status Filter',
    annotationReply: 'Annotation Reply',
    noTaskRecords: 'No task records',
    startFirstTask: 'Upload patent documents to start the first task',
    supportedFormatsError: 'Only supports PDF, DOC, DOCX file formats!',
    fileSizeLimitError: 'File size cannot exceed 10MB!',
    uploadingInfo: 'Uploading file...',
    uploadSuccess: 'File uploaded successfully',
    uploadFailed: 'File upload failed',
    pleaseUploadFile: 'Please upload patent documents first',
    taskSubmitted: '{taskName} task submitted, please check the results in the list',
    taskSubmissionFailed: 'Task submission failed',
    noPDF: 'This task has no PDF file',
    noWord: 'This task has no Word file',
    defaultPrompt: 'Upload file',
    annotationResult: 'Annotation Simulation',
  },
  auth: {
    login: 'Login',
    register: 'Register',
  ...
  patentSearch: {
    ...
    downloadReport: 'Download Report - Payment Required',
    ...
    paying: 'Processing...',
    scanQRCode: 'Please use {method} to scan the QR code',
    generatingQRCode: 'Generating payment QR code...',
    orderNumber: 'Order Number:',
    qrCodeLoadFailed: 'QR code image failed to load',
    paymentFailed: 'Payment failed, please try again',
    taskIdEmpty: 'Task ID is empty, unable to process payment',
  },
  techReport: {
  ...
  patentDraft: {
    ...
    nameLength: 'Invention name length should be 3-50 characters',
