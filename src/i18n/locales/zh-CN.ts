...
export default {
  ...
  menu: {
    ...
    defenseAnnotation: {
    title: '批注回复',
    subtitle: '上传专利文件，生成批注回复意见',
    uploadTitle: '专利文件上传',
    uploadText: '将专利申请文件拖到此处，',
    clickUpload: '点击上传',
    fileFormatTip: '支持 PDF、DOC、DOCX 格式，文件大小不超过 10MB',
    generateAnnotationReply: '生成批注回复',
    taskRecords: '任务记录',
    statusFilter: '状态筛选',
    annotationReply: '批注回复',
    noTaskRecords: '暂无任务记录',
    startFirstTask: '上传专利文件开始首次任务',
    supportedFormatsError: '只支持 PDF、DOC、DOCX 格式的文件！',
    fileSizeLimitError: '文件大小不能超过 10MB！',
    uploadingInfo: '正在上传文件...',
    uploadSuccess: '文件上传成功',
    uploadFailed: '文件上传失败',
    pleaseUploadFile: '请先上传专利文件',
    taskSubmitted: '{taskName}任务已提交，请在列表中查看结果',
    taskSubmissionFailed: '任务提交失败',
    noPDF: '该任务暂无PDF文件',
    noWord: '该任务暂无Word文件',
    defaultPrompt: '上传文件',
    annotationResult: '批注模拟',
  },
  auth: {
    login: '登录',
    register: '注册',
