export default {
  ...
  defenseAnnotation: {
    title: 'رد التعليق التفسيري',
    subtitle: 'قم بتحميل وثائق البراءة لتوليد آراء ردود التعليق التفسيري',
    uploadTitle: 'تحميل وثيقة البراءة',
    uploadText: 'اسحب وثائق طلب البراءة هنا،',
    clickUpload: 'انقر للتحميل',
    fileFormatTip: 'يدعم تنسيقات PDF و DOC و DOCX، حجم الملف لا يتجاوز 10 ميغابايت',
    generateAnnotationReply: 'توليد رد التعليق التفسيري',
    taskRecords: 'سجلات المهام',
    statusFilter: 'مرشح الحالة',
    annotationReply: 'رد التعليق التفسيري',
    noTaskRecords: 'لا توجد سجلات مهام',
    startFirstTask: 'قم بتحميل وثائق البراءة لبدء المهمة الأولى',
    supportedFormatsError: 'يتم دعم تنسيقات الملفات PDF و DOC و DOCX فقط!',
    fileSizeLimitError: 'لا يمكن أن يتجاوز حجم الملف 10 ميغابايت!',
    uploadingInfo: 'جارٍ تحميل الملف...',
    uploadSuccess: 'تم تحميل الملف بنجاح',
    uploadFailed: 'فشل تحميل الملف',
    pleaseUploadFile: 'يرجى تحميل وثائق البراءة أولاً',
    taskSubmitted: 'تم إرسال مهمة {taskName}، يرجى التحقق من النتائج في القائمة',
    taskSubmissionFailed: 'فشل إرسال المهمة',
    noPDF: 'لا تحتوي هذه المهمة على ملف PDF',
    noWord: 'لا تحتوي هذه المهمة على ملف Word',
    defaultPrompt: 'تحميل الملف',
    annotationResult: 'محاكاة التعليق التفسيري',
  },
  auth: {
    login: 'تسجيل الدخول',
    register: 'التسجيل',
