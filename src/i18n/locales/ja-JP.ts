export default {
  ...
  defenseAnnotation: {
    title: '注釈返信',
    subtitle: '特許文書をアップロードして注釈返信意見を生成',
    uploadTitle: '特許文書アップロード',
    uploadText: '特許出願書類をここにドラッグ，',
    clickUpload: 'クリックしてアップロード',
    fileFormatTip: 'PDF、DOC、DOCX形式をサポート、ファイルサイズは10MBを超えない',
    generateAnnotationReply: '注釈返信を生成',
    taskRecords: 'タスク記録',
    statusFilter: 'ステータスフィルター',
    annotationReply: '注釈返信',
    noTaskRecords: 'タスク記録なし',
    startFirstTask: '特許文書をアップロードして最初のタスクを開始',
    supportedFormatsError: 'PDF、DOC、DOCXファイル形式のみサポートされています！',
    fileSizeLimitError: 'ファイルサイズは10MBを超えることはできません！',
    uploadingInfo: 'ファイルアップロード中...',
    uploadSuccess: 'ファイルアップロード成功',
    uploadFailed: 'ファイルアップロード失敗',
    pleaseUploadFile: 'まず特許文書をアップロードしてください',
    taskSubmitted: '{taskName}タスクが送信されました。リストで結果を確認してください',
    taskSubmissionFailed: 'タスク送信失敗',
    noPDF: 'このタスクにはPDFファイルがありません',
    noWord: 'このタスクにはWordファイルがありません',
    defaultPrompt: 'ファイルをアップロード',
    annotationResult: '注釈シミュレーション',
  },
  auth: {
    login: 'ログイン',
    register: '登録',
